...
from running_strategies import MainActivityInvocationStrategy
...
def runMainActivityStrategy(adb, androidManifest):
    automaticTriggeringStrategy = MainActivityInvocationStrategy(adbDevice=adb, pathToAndroidManifest=androidManifest)
